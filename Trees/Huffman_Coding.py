...
def count_char(text):
    """
    create an array with the count of each character in the text input.
    The elements in position 0,2,4,..,2K are the number of occurrences for
    the corresponding character in position 1,3,5,..,2K+1.
...
def combine(nodes, tree):
    """
    recursively combines base nodes to
    create the huffman tree and allocates
    either a 0 or 1 to each pair of nodes.
...
def huffman_encoding(data):
    ...
    # and creates an array nodelist with just the nodes.
...
if __name__ == "__main__":
    ...
    a_great_sentence = "my name is omar ehab, and this is huffman coding problem"
